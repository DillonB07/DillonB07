...
Since then, I have pushed **842** commits, opened **67** issues, submitted **43** pull requests, received **18** stars across **43** personal projects and contributed to **52** public repositories.
...
4. ❗️ Opened issue [#5473](https://github.com/cli/cli/issues/5473) in [cli/cli](https://github.com/cli/cli)
